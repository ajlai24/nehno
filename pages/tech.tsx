            ...
            <Box pr={2}>
              <OverlineBox id="back-to-top-anchor">
                ...
                <Typography mt={2} color="text.secondary">
                  A place to describe all the nifty stuff used to build this
                  site
                </Typography>
              </OverlineBox>
              <TextSection header={anchors[0].label} id={anchors[0].id}>
                <Typography>
                  ...
                  of things to consider even on a seemingly simple app like
                  this. I find that looking at example code is sometimes more
                  helpful so if you&apos;re not too interested in reading feel
                  free to jump to the
                </Typography>
                <Button
                  sx={{ mt: 1 }}
              ...
              <TextSection header={anchors[1].label} id={anchors[1].id}>
                ...
                >
                  <Paragraph>
                    ...
                    side rendered app using Webpack and Express.js instead.
                    There are some differences to accommodate for between server
                    side and client side rendering but the gap is narrowing.
                  ...
                  <Card sx={{ display: 'flex', padding: 2, mb: 3 }}>
                    <Grid container alignItems="center">
                      <Grid item xs={12} sm={8} lg={9}>
                        ...
                        project as it&apos;s server side rendered and really
                ...
                <NumberedSection number={2} header="Building Method">
                  ...
                  <ul>
                    ...
                    <li>
                      Cloning the numerous example template repos out in the
                      wild
                    </li>
                    <li>
                  ...
                  <Paragraph>
                    Whichever method you pick, make sure you know what
                    you&apos;re trying to accomplish with the app and how
                    you&apos;re going to integrate the backend server. Some
                    methods are quicker to get up and running but leave less
                    room for customization as they may be more opinionated.
                  </Paragraph>
                  <Paragraph>
                    For this site where the routing isn&apos;t too complicated,
                    no authentication, and not a ton of business logic,{' '}
                  ...
                  <Typography>
                    ...
                    it&apos;s a hospitality business with a lot of complex
                    cases, I built a React app from scratch using Webpack and
                    Express.js. Getting it built up took some more time but as a
                    result, it is fully customizable and can deal with almost
              ...
              <TextSection header={anchors[2].label} id={anchors[2].id}>
                <Paragraph>
                  ...
                  <Link href="https://vercel.com/">Vercel</Link> was the tool
                  for deployments and it was truly a delight. Testable
                  production instances get built and deployed on any pushes to
                  any branch. Promoting any of those instances to production is
                ...
                <Paragraph>
                  ...
                  <Link href="https://vercel.com/pricing">FREE</Link> version
                  too!
                </Paragraph>
                ...
                <Typography>
                  Having worked for Salesforce, I&apos;ve tried Heroku in the
                  past and while it was pretty hands off and easy as well, the
                  free version will sleep after 30 minutes of inactivity. That
                  means the first person to access the site after that 30
                  minutes of activity will see a very extended initial load
                  time. Obviously this{' '}
              ...
              <TextSection header={anchors[3].label} id={anchors[3].id}>
                <Paragraph>
                  This is where the bulk of my time was spent thinking and
                  coding. There are so many little details that go into making a
                  web app that are seemingly insignificant but they really add
                  up.
                </Paragraph>
                <ul>
                  <li>
                    Responsive design - making the experience as good in
                    different screen sizes, even when on your phone. This not
                    only requires different components for mobile vs desktop
                    (like the menu) but also responsive font sizes and padding
                    for different resolutions.
                  </li>
                  <li>
                    The sticky table of contents you see to your right on
                    desktop but hidden on mobile
                  </li>
                  <li>
                    Scroll to top button that appears after a certain distance
                    has been scrolled
                  </li>
                  <li>
                ...
                <Typography>
                  Of the component libraries I&apos;ve come across, I&apos;ve
                  come to really like <Link href="https://mui.com/">MUI</Link>,
                  formerly known as Material UI.
                </Typography>
                ...
                <Typography>
                  It&apos;s really a full suite of components and tools that
                  makes it really easy and quick to develop. It&apos;s got
                  theming, darkmode, responsive media queries, and lots of
                  components all of which are fully customizable. I&apos;ve used
                  mostly the defaults on this app with some tweaks here and
              ...
              <TextSection header={anchors[4].label} id={anchors[4].id}>
                <Typography>
                  ...
                  site, for business apps it&apos;s important to always have
                  unit testing as well as end to end testing. These days
                  I&apos;ve been using{' '}
              ...
              <TextSection header={anchors[5].label} id={anchors[5].id}>
                <Paragraph>
                  ...
                  / Webstorm, Sublime, and Visual Studio Code. My favorite as of
                  now is{' '}
